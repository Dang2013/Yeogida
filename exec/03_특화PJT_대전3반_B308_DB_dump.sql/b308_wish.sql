...
CREATE TABLE `wish` (
  ...
  KEY `FK2p11qca1l0s1x083ujbppnack` (`tour_id`),
  CONSTRAINT `FK2p11qca1l0s1x083ujbppnack` FOREIGN KEY (`tour_id`) REFERENCES `tour` (`id`),
...
INSERT INTO `wish` VALUES (1,1,1648),(4,1,190),(11,5,1424),(13,1,15048);
